...
from utils import parse_softmax_temperature
...
def eval_dataset(dataset_path, width, softmax_temp, opts):
    ...
    if opts.multiprocessing:
        ...
        # p = 15
        # radiu = 500
        # dataset = './data/MCLP/MCLP_100_20_1000_test_2000_BN.pkl'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_size', type=int, default=10,
                        help='Number of instances used fo r reporting validation performance')
    ...
    parser.add_argument('--max_calc_batch_size', type=int, default=100000, help='Size for subbatches')
