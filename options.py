...
def get_options(args=None):
    ...
    # training problem specifications
    parser.add_argument('--problem', type=str, default='MCLP', help="The problem to solve, default 'PM'")
    parser.add_argument('--n_users', type=int, default=100, help="The number of the demand points")
    parser.add_argument('--n_facilities', type=int, default=50, help="The number of points in CLS (candidate location set) ")
    parser.add_argument('--p', type=int, default=15, help="The number of the facilities to be selected")
    parser.add_argument('--r', type=float, default=None, help="The maximum service distance (coverage radius)")
    parser.add_argument('--batch_size', type=int, default=640, help='Number of instances per batch during training')
    parser.add_argument('--epoch_size', type=int, default=128000, help='Number of instances per epoch during training')
    parser.add_argument('--val_size', type=int, default=2000, help='Number of instances used for reporting validation performance')
    ...
    parser.add_argument('--baseline', default=None, help="Baseline to use: 'rollout', 'critic' or 'exponential'. Defaults to no baseline.")
    ...
    opts.run_name = "{}_{}_{}_{}".format(opts.n_users, opts.n_facilities, opts.p, time.strftime("%Y%m%dT%H%M%S"))
